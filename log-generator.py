...
def buildPath():
    # build random Path
    path_list=['/index.cccccchtml', '/contact.html', '/contact/submit.html', '/about.html','/products.html','/services.html','/support.html']
...
log_File = open('/home/benidder/IdeaProjects/Stream_project/src/main/scala/log-generator.log', 'w')
